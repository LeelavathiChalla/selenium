...
import com.orangehrm.pages.Admin_PageFactory;
import com.orangehrm.pages.Leave_PageFactory;
import com.orangehrm.pages.PIM_PageFactory;
import com.orangehrm.pages.Time_Pagefactory;
...
public class OrangeHRM_All_Modules extends BaseTest {
    ...
    public void addUserTest(String role, String empName, String status,
        ...
        try {
            Admin_PageFactory adminPage = new Admin_PageFactory(driver);
    ...
    public void employeeTimesheetFlowTest() {
        ...
        try {
            ...
            Time_Pagefactory timePage = new Time_Pagefactory(driver);
    ...
    public void assignLeaveFlowTest() {
        ...
        try {
            ...
            Leave_PageFactory leavePage = new Leave_PageFactory(driver);
